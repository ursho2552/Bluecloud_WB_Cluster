...
list_bio_wrapper <- function(FOLDER_NAME = "test_run",
  ...
  if(DATA_SOURCE != "abundance" & DATA_SOURCE != "occurrence" & DATA_SOURCE != "omic"){
    stop("The specified data source should be 'abundance', 'occurrence' or 'omic'")
  }
